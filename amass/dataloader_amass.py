...
class Datasets(Dataset):
    ...
    def __init__(self,data_dir,input_n,output_n,skip_rate, actions=None, split=0):
        ...
        :param sample_rate:
        """
        self.path_to_data = '/media/bouazia/bouazia_3/AMASS_dataset/' #os.path.join(data_dir,'AMASS')         #  "D:\data\AMASS\\"
        self.split = split
        self.in_n = input_n
        self.out_n = output_n
        ...
        # load mean skeleton
        skel = np.load('/lhome/bouazia/pose_prediction/utils/body_models/smpl_skeleton.npz')
